...
public final class BotUtils {
        ...
        public static void readGuildInfo(final JDA bot) {
            try {
                ...
                for (var guildIndex = 0; guildIndex < json.size(); guildIndex++) {
                    ...
                    info.showcasesID = getOrDefaultJson(guildObject, "ShowcasesChannelID",
                            820454246923108352L).getAsLong();
                    info.starboardID = getOrDefaultJson(guildObject, "StarboardChannelID",
                            820451994606239765L).getAsLong();
                    ...
                    info.includeBotStar = getOrDefaultJson(guildObject, "ShouldIncludeBotStar", true)
                            .getAsBoolean();
                    info.enableStarboard = getOrDefaultJson(guildObject, "StarboardEnabled", true)
                            .getAsBoolean();
    ...
    public static final class WarnUtils {
        ...
        public static void clearWarns(final Guild guild, final Member clearer, final Member toClear) {
            ...
            if (loggingChannel != null) {
                final var embed = new EmbedBuilder().setColor(Color.BLUE)
                        ...
                        .setDescription("**Cleared By**: " + clearer.getAsMention())
        ...
        public static boolean removeWarnByUUID(final Guild guild, final Member remover,
